            ...
            <div class="col-12">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$product->name ?? 'None'}}</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image??'None'}}" class="img-fluid blur-up lazyload" alt="{{$product->name??'None'}}">
                                        </div>
                                        @if($product->images??'None')
                                        @php
                                            $images = explode(',',$product->images??'None');
                                        @endphp
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image??'None'}}" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->name??'None'}}">
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    <del>${{$product->regular_price??'None'}}</del><span>
                                        {{ round((($product->regular_price - $product->sale_price??'None')/$product->regular_price??'None')*100) }}
                                        % off</span>
                                    @else
                                ...
                                <div class="product-buttons">
                                    ...
                                    <a href="javascript:void(0)"  class="btn btn-solid hover-solid btn-animation failed-heard" onclick="document.getElementById('remouve-item').submit()";>
                                        <i class="fa fa-bookmark fz-16 me-2"></i>
                                        <span>Remove from Wishlist</span>
                                        <form method="POST" id="remouve-item" action="{{route('wishlist.remove',['rowId'=>Cart::instance("wishlist")->content()->Where('id',$product->id)->first()->rowId])}}">
                                            @csrf
                                            @method("DELETE")
                                        </form>
                                    </a>
                                    ...
                                    <a href="javascript:void(0)" onclick="document.getElementById('wishlist-form').submit();" class="btn btn-solid hover-solid btn-animation" >
                                        <i class="fa fa-bookmark fz-16 me-2"></i>
                                    ...
                                    <a href="{{route('cart.index')}}" class="btn btn-solid hover-solid btn-animation">Go to Cart</a>
                                    @else
                                    ...
                                    <div class="product-single__addtocart">
                                        ...
                                        <input type="hidden" name="price" value="{{$product->sale_price == '' ? $product->regular_price:$product->sale_price}}" />
                                        <input type="hidden" name="quantity" value="1"/>
                                        <button type="submit" class="btn btn-solid hover-solid btn-animation "><i class="fa fa-shopping-cart"></i><span>Add to Cart</span></button>
                                    </div>
                                    </form>
                                    @endif
