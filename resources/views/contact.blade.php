...
<section class="text-gray-600 body-font relative">
    <div class="container ">
        <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Thank you for contacting us</p>
        </div>
        @if (session()->has('success'))
            <div class="relative flex flex-col sm:flex-row sm:items-center bg-gray-200 dark:bg-green-700 shadow rounded-md py-5 pl-6 pr-8 sm:pr-6 mb-3 mt-3">
                ...
                <div class="text-sm tracking-wide text-gray-500 green:text-white mt-4 sm:mt-0 sm:ml-4"> {{ session('success') }}</div>
